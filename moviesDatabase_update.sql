...
CREATE TABLE USERS(
    ...
    Favorite_Genres_ID INTEGER NOT NULL,
    Favorite_Movies_ID INTEGER NOT NULL,
    PRIMARY KEY(Username)
        
);

INSERT INTO USERS VALUES ('gothicVamp2', 100, 1000);

INSERT INTO USERS VALUES ('sinPal_32', 101, 1001);

INSERT INTO USERS VALUES ('dreamsOfSpace', 102, 1002);

INSERT INTO USERS VALUES ('crimeBoss23', 103, 1003);

INSERT INTO USERS VALUES ('pixarFan_78', 104, 1004);

INSERT INTO USERS VALUES ('nytCool23', 105, 1005);

INSERT INTO USERS VALUES ('thrillerSeeker7', 106, 1006);

INSERT INTO USERS VALUES ('wildWest_66', 107, 1007);

INSERT INTO USERS VALUES ('RoseLoves', 108, 1008);

INSERT INTO USERS VALUES ('actionPanorama', 109, 1009);

INSERT INTO USERS VALUES ('adventureJunky', 110, 1010);

INSERT INTO USERS VALUES ('silentFilmsfan', 111, 1011);

INSERT INTO USERS VALUES ('laughHappy23', 112, 1012);
...
CREATE TABLE FAVORITE_GENRES(
    ...
    FOREIGN KEY (Genre) REFERENCES GENRES(Genre)
        ON DELETE SET NULL,
    FOREIGN KEY (Favorite_Genres_ID) REFERENCES USERS(Favorite_Genres_ID)
        ON DELETE CASCADE
);

INSERT INTO FAVORITE_GENRES VALUES ('Fantasy', 100, 700);

INSERT INTO FAVORITE_GENRES VALUES ('Sci-Fi', 101, 701);

INSERT INTO FAVORITE_GENRES VALUES ('Horror', 102, 702);

INSERT INTO FAVORITE_GENRES VALUES ('Thriller', 103, 703);

INSERT INTO FAVORITE_GENRES VALUES ('Drama', 104, 704);

INSERT INTO FAVORITE_GENRES VALUES ('Romance', 105, 705);

INSERT INTO FAVORITE_GENRES VALUES ('Action', 106, 706);

INSERT INTO FAVORITE_GENRES VALUES ('Adventure', 107, 707);

INSERT INTO FAVORITE_GENRES VALUES ('Animation', 108, 708);

INSERT INTO FAVORITE_GENRES VALUES ('Musical', 109, 709);
...
CREATE TABLE FAVORITE_MOVIES(
    ...
    FOREIGN KEY (Movie_ID) REFERENCES MOVIES(Movie_ID)
        ON DELETE CASCADE,
    FOREIGN KEY (Favorite_Movies_ID) REFERENCES USERS(Favorite_Movies_ID)
        ON DELETE CASCADE
);

INSERT INTO FAVORITE_MOVIES VALUES (1, 1000, 500);

INSERT INTO FAVORITE_MOVIES VALUES (2, 1001, 501);

INSERT INTO FAVORITE_MOVIES VALUES (9, 1002, 502);

INSERT INTO FAVORITE_MOVIES VALUES (20, 1003, 503);

INSERT INTO FAVORITE_MOVIES VALUES (28, 1004, 504);

INSERT INTO FAVORITE_MOVIES VALUES (25, 1005, 505);

INSERT INTO FAVORITE_MOVIES VALUES (26, 1006, 506);

INSERT INTO FAVORITE_MOVIES VALUES (30, 1007, 507);

INSERT INTO FAVORITE_MOVIES VALUES (23, 1008, 508);

INSERT INTO FAVORITE_MOVIES VALUES (24, 1009, 509);
